#!/bin/python3
# I wrote this to find the page a fake Covid-19 vaccine passport web site hosted by neocites (Still waiting for a responce from them).
...
# The vaccine isn't an invasion of you're rights, its an obligation of living in a productive society.
